  ...
  <div id="deviceDetail">
    <el-form :model="form" ref="taskForm" :rules="taskRules" label-width="150px">
      ...
      <el-form-item label="摆放位置" required>
        <el-form-item class="addr-sel" prop="provinceId">
          <el-select class="address-select" v-model="form.provinceId" @change="changeProvince" placeholder="请选择省">
            <el-option v-for="p in provinces" :label="p.name" :value="p.code" :key="p.id" :disabled="true"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item class="addr-sel" prop="cityId">
          <el-select class="address-select" v-model="form.cityId" @change="changeCity" placeholder="请选择市">
            <el-option v-for="c in cities" :label="c.name" :value="c.code" :key="c.id" :disabled="true"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item class="addr-sel" prop="districtId">
          <el-select class="address-select" v-model="form.districtId" placeholder="请选择区">
            <el-option v-for="d in districts" :label="d.name" :value="d.code" :key="d.id" :disabled="true"></el-option>
          </el-select>
        </el-form-item>
      </el-form-item>
      ...
      <el-form-item label="地址标签" prop="address">
        <el-input v-model="form.abbreviatedAddress" :maxlength="8" :disabled="true"></el-input>
      </el-form-item>
      <el-form-item label="维护人姓名" prop="maintainPersonName">
        <el-input v-model="form.maintainPersonName" :disabled="true"></el-input>
      </el-form-item>
      <el-form-item label="维护人电话" prop="maintainPersonPhone">
        <el-input v-model="form.maintainPersonPhone" :maxlength=11 :disabled="true"></el-input>
      </el-form-item>
      <el-form-item label="商务姓名" prop="bdName">
        <el-input v-model="form.bdName" :disabled="true"></el-input>
      </el-form-item>
      <el-form-item label="商务电话" prop="bdPhone">
        <el-input v-model="form.bdPhone" :maxlength=11 :disabled="true"></el-input>
      </el-form-item>
      <el-form-item label="备注">
        <el-input class="input-area" type="textarea" v-model="form.memo" :disabled="true"></el-input>
      </el-form-item>
      <el-form-item>
